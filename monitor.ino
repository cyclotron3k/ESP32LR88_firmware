enum cmds {
  CMD_NONE, CMD_ST, CMD_RB, CMD_IP, CMD_SB, CMD_GW, CMD_AP, CMD_PD,
  CMD_SD, CMD_SS, CMD_PW, CMD_PA, CMD_MS, CMD_MP, CMD_MD, CMD_R1, CMD_R2,
  CMD_R3, CMD_R4, CMD_R5, CMD_R6, CMD_R7, CMD_R8, CMD_N1, CMD_N2, CMD_N3,
  CMD_N4, CMD_N5, CMD_N6, CMD_N7, CMD_N8
};
